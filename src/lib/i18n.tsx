  ...
  ar: {
    ...
    clarity: {
      ...
      blocks: [
        ...
        },
        {
          ...
          text: "تابع أرصدة حسابات العملاء والموردين والخزن في مكان واحد، مع شجرة دليل محاسبي تنظم كل عملياتك.",
        },
        {
          tag: "نقاط البيع",
          title: "نقاط البيع التفاعلية",
          text: "واجهة عرض تفاعلية لنظام الكاشير لإدارة عمليات البيع وعرض المنتجات وإتمام الدفع ومتابعة مراحل التصنيع.",
        },
        {
          tag: "المالية من الألف للياء",
          title: "من المعاملة إلى الميزانية العمومية",
          text: "تابع كل العمليات الخاصة بشركتك من أول المعاملات المالية اليومية حتى الميزانية العمومية والأرباح والخسائر.",
        },
        {
          tag: "الموارد البشرية",
    ...
    features: {
      ...
      items: [
        ...
        { t: "نقاط البيع", d: "واجهة كاشير تفاعلية لإدارة البيع والمنتجات والدفع ومراحل التصنيع." },
