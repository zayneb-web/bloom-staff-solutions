...
export const translations = {
  fr: {
    ...
    clarity: {
      badge: "Clarté",
      title: "Conçu pour Ramener la",
      titleHighlight: "Clarté",
      subtitle:
        "Plus de plannings perdus, plus de stress de fin de mois. Juste de la fluidité, de la sérénité et la maîtrise totale de vos équipes.",
      ...
      blocks: [
        {
          ...
          text: "Les fiches de paie manuelles, les erreurs de calcul, le stress de fin de mois. Retex Solution calcule automatiquement salaires, heures sup et déductions — sans erreur, sans retard.",
        },
        {
          tag: "Présence",
    ...
    features: {
      ...
      titleHighlight: "Toutes Vos Opérations RH",
      items: [
        { t: "Gestion des Employés", d: "Profils, contrats, départements et dossiers RH centralisés." },
        { t: "Présence & Biométrie", d: "Connectez vos pointeuses, suivi automatique des présences." },
        { t: "Planification des Shifts", d: "Créez les plannings, comparez heures prévues vs réelles." },
        { t: "Gestion des Congés", d: "Congés payés, maladie, vacances gérés simplement." },
        { t: "Paie Automatisée", d: "Calcul auto des salaires, heures sup, primes et déductions." },
        { t: "Évaluation de Performance", d: "Suivi et notation des performances de vos employés." },
        { t: "Rapports & Analytics", d: "Rapports de présence, paie, heures sup et insights RH." },
      ],
    },
    benefits: {
      badge: "Avantages",
  ...
  en: {
    ...
    clarity: {
      badge: "Clarity",
      title: "Built to Bring Back",
      titleHighlight: "Clarity",
      subtitle:
        "No more lost schedules or end-of-month stress. Just smooth operations, peace of mind and full control of your teams.",
      ...
      blocks: [
        {
          tag: "Payroll",
          title: "No More Approximate Payroll",
          text: "Manual payslips, calculation errors, end-of-month stress. Retex Solution automatically calculates salaries, overtime and deductions — accurately and on time.",
        },
        {
          tag: "Attendance",
          title: "Every Attendance Counted, Every Minute Tracked",
          text: "Connect your biometric devices and let the platform centralize attendance in real time. No more Excel sheets, no more doubts.",
        },
        {
          tag: "Scheduling",
          title: "Smart Where It Matters",
          text: "We don't just automate — we anticipate. The platform learns your team rhythms and structures your HR days.",
        },
      ],
    },
    features: {
      badge: "Features",
      title: "One Platform.",
      titleHighlight: "All Your HR Operations",
      items: [
        { t: "Employee Management", d: "Profiles, contracts, departments and centralized HR files." },
        { t: "Attendance & Biometrics", d: "Connect your time clocks, automatic attendance tracking." },
        { t: "Shift Scheduling", d: "Create schedules, compare planned vs actual hours." },
        { t: "Leave Management", d: "Paid leave, sick days and vacations managed simply." },
        { t: "Automated Payroll", d: "Auto calculation of salaries, overtime, bonuses and deductions." },
        { t: "Performance Reviews", d: "Track and rate your employees' performance." },
        { t: "Reports & Analytics", d: "Attendance, payroll, overtime reports and HR insights." },
      ],
    },
    benefits: {
      badge: "Benefits",
