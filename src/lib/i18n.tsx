...
export const translations = {
  fr: {
    ...
    clarity: {
      ...
      blocks: [
        ...
        },
        {
          ...
          text: "Arbre du plan comptable pour définir tous les éléments de comptes nécessaires à chaque opération financière et comptable.",
          image: "accounts",
        },
        {
          tag: "Point de Vente",
        ...
        },
        {
          ...
          text: "Réalisez toutes les opérations financières de votre entreprise en un seul endroit.",
          image: "finance",
        },
        {
    ...
    contact: {
      ...
      successMessage: "Merci. Votre demande a bien ete envoyee et notre equipe vous recontactera rapidement.",
      errorMessage: "Echec de l'envoi. Merci de reessayer dans quelques instants.",
      autoReply:
        "Merci pour votre message. Nous avons bien recu votre demande et notre equipe vous contactera sous 24h.",
      autoReplySubject: "Retex Solution — Confirmation de votre demande",
      close: "Fermer",
      offices: "Nos Bureaux",
      location: "Miami, Alexandrie, Égypte",
      phoneNum: "+20 122 426 4564",
      mail: "solutionretex@gmail.com",
  ...
  en: {
    ...
    clarity: {
      ...
      blocks: [
        ...
        },
        {
          ...
          text: "Chart of accounts tree to define every account element needed for all financial and accounting operations.",
          image: "accounts",
        },
        {
          tag: "Point of Sale",
        ...
        },
        {
          ...
          text: "Run all your company's financial operations in one place.",
          image: "finance",
        },
        {
          tag: "Human Resources",
    ...
    testimonials: {
      ...
      roles: [
        ...
        "General Management, Reemaj Hotel — Saudi Arabia",
      ],
    },
    pricing: {
      badge: "Pricing",
    ...
    contact: {
      ...
      successMessage: "Thanks. Your request has been sent and our team will contact you shortly.",
      errorMessage: "Sending failed. Please try again in a moment.",
      autoReply:
        "Thanks for your message. We have received your request and our team will contact you within 24 hours.",
      autoReplySubject: "Retex Solution — Request confirmation",
      close: "Close",
      offices: "Our Offices",
  ...
  ar: {
    ...
    clarity: {
      badge: "الوحدات",
      title: "منصة واحدة لإدارة",
      titleHighlight: "كل شيء",
      subtitle:
        "المخازن والحسابات والمبيعات والموارد البشرية والمالية — أدر نشاطك بالكامل من واجهة واحدة موحدة.",
      learnMore: "اعرف المزيد",
      before: "قبل Retex Solution",
      after: "بعد Retex Solution",
      beforeItems: [
        "أرصدة مخازن غير معروفة",
        "حسابات عملاء وموردين مبعثرة",
        "مشتريات بدون متابعة",
        "لا يوجد تحليل للمبيعات",
        "دليل محاسبي ارتجالي",
        "مراحل تصنيع غير مرئية",
        "تسجيل حضور يدوي للموظفين",
        "ساعات إضافية وخصومات بالتخمين",
        "أرباح الفروع يصعب فصلها",
        "عمليات مالية مشتتة",
      ],
      afterItems: [
        ...
        "الوقت الإضافي والمخصوم للموظفين",
        "أرباح وخسائر كل فرع",
        "كل المعاملات المالية في مكان واحد",
      ],
      blocks: [
        {
          tag: "المخازن",
        ...
        },
        {
          ...
          text: "شجرة الدليل المحاسبي لتعريف كل عناصر الحسابات اللازمة لكل العمليات المالية والمحاسبية في البرنامج.",
          image: "accounts",
        },
        {
          tag: "نقاط البيع",
        ...
        {
          tag: "المالية من الألف للياء",
          title: "من المعاملة إلى الميزانية العمومية",
          text: "قم بكل عملياتك المالية الخاصة بشركتك في مكان واحد.",
          image: "finance",
        },
        {
          tag: "الموارد البشرية",
          title: "إدارة الموارد البشرية",
          text: "تابع حضور وانصراف الموظفين ومواعيد عملهم اليومية والإضافات والخصومات وتقييم الأداء واستحقاقات نهاية الشهر.",
          image: "hr",
        },
      ],
    },
    features: {
      badge: "الميزات",
      title: "منصة واحدة.",
      titleHighlight: "كل عمليات شركتك",
      items: [
        { t: "إدارة المخازن", d: "تابع كل أرصدة أصنافك في المخازن المختلفة مع جرد دوري للأصناف." },
        { t: "إدارة الحسابات", d: "تابع أرصدة حسابات العملاء والموردين والخزن في مكان واحد." },
        { t: "التصنيع", d: "متابعة مراحل التصنيع المختلفة." },
        { t: "المالية من الألف للياء", d: "من المعاملات اليومية إلى الميزانية العمومية والأرباح والخسائر." },
        { t: "الموارد البشرية", d: "حضور وانصراف، مواعيد، إضافات، خصومات، تقييم واستحقاقات الموظفين." },
        { t: "المبيعات والأرباح", d: "تابع مبيعاتك وأرباحك من كل صنف وعميل ونمو المبيعات في فترة محددة." },
      ],
    },
    benefits: {
      badge: "المزايا",
    ...
    testimonials: {
      ...
      roles: [
        ...
        "الإدارة العامة، فندق ريماج — المملكة العربية السعودية",
      ],
    },
    pricing: {
      badge: "الأسعار",
    ...
    contact: {
      ...
      successMessage: "شكرا لك. تم إرسال طلبك وسيتواصل معك فريقنا قريبا.",
      errorMessage: "فشل الإرسال. يرجى المحاولة مرة أخرى بعد قليل.",
      autoReply: "شكرا لرسالتك. تم استلام طلبك وسيتواصل معك فريقنا خلال 24 ساعة.",
      autoReplySubject: "Retex Solution — تأكيد استلام طلبك",
      close: "إغلاق",
      offices: "مكاتبنا",
